...
const basePath = '/cnno-1776324845562';
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-xl shadow-sm">
        <div className="flex justify-between items-center w-full px-8 py-4 max-w-7xl mx-auto">
          <div className="flex items-center gap-3">
            <img src="https://lh3.googleusercontent.com/d/1OluC5K7W3rr48yYYjHbu5whqyQ2_sqr3" alt="CNNO" className="h-10 w-auto object-contain" />
          </div>
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">To craft and deliver exceptional artisanal cinnamon rolls that exceed customer expectations, fostering a warm and inviting experience in every bite.</p>
                </div>
                <div className="space-y-2">
